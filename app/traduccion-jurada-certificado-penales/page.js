  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mt-2 text-sm text-slate-500">
        Para trámites de nacionalidad o extranjería también solemos traducir la <a href="/traduccion-jurada-partida-nacimiento" className="underline hover:text-brand-gold-700">partida de nacimiento</a>.
      </p>
    </main>
  );
}
